export const elements = {
	...
	searchHeadingCog:document.querySelector('.index-search__heading-icon'),
	searchPaginationContainer:document.querySelector('.index-search__content-pages'),
	searchHeadingFormClose:document.querySelector('.form__heading-close'),
	searchingStartButtons:document.querySelectorAll('.form__btn'),
